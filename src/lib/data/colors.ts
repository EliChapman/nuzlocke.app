...
interface IPalette {
  ...
  rock: THex, psychic: THex, bug: THex, '???': THex, crystal: THex,
  special: [THex, THex],
  physical: [THex, THex],
  status: [THex, THex]
}
...
const palettes: Record<string, IPalette> = {
  default: {
    ...
    '???': '#69a190', crystal: '#44c3c2',
    special: ['#5273ad', '#bbd1f1'], 
    physical: ['#f85131', '#ffc631'], 
  ...
  legacy: {
    ...
    rock: '#bca55b', psychic: '#ff73a5', bug: '#adbd21', 
    '???': '#69a190', crystal: '#44c3c2',
    special: ['#5273ad', '#bbd1f1'],
    physical: ['#f85131', '#ffc631'], 
    status: ['#ada594', '#ffffff']
  ...
  bright: {
    ...
    rock: '#a28c20', psychic: '#f366b9', bug: '#719f3e',
    '???': '#69a190', crystal: '#3ed6d5',
    special: ['#5273ad', '#bbd1f1'], 
    physical: ['#f85131', '#ffc631'],
    status: ['#ada594', '#ffffff']
  },
  ...
  bold: {
    ...
    rock: '#8a3e22', psychic: '#f71b92', bug: '#3c9950',
    '???': '#69a190', crystal: '#16a1a0',
    special: ['#5273ad', '#bbd1f1'],
    physical: ['#f85131', '#ffc631'],
    status: ['#ada594', '#ffffff']
  },
  ...
  muted: {
    ...
    rock: '#c8b88c', psychic: '#f87177', bug: '#91c327', 
    '???': '#69a190', crystal: '#49a3a2',
    special: ['#5273ad', '#bbd1f1'], 
    physical: ['#f85131', '#ffc631'],
    status: ['#ada594', '#ffffff']
  }
